...
def get_data(movie_id):
    ...
    try:
        title = tree.xpath(
            '//*[@id="root"]/div[1]/section/div/div[2]/div/div/div[1]/div[2]/div/h1/text()'
        )[0].replace("/", " ")
    except Exception:
        title = None
    try:
        movie_info = tree.xpath(
            '//*[@id="root"]/div[1]/section/div/div[2]/div/div/div[1]/div[2]/div/div[2]/text()'
        )[0].split("·")
    ...
    try:
        movie_info2 = tree.xpath(
            '//*[@id="root"]/div[1]/section/div/div[2]/div/div/div[1]/div[2]/div/div[3]/text()'
        )[0].split("·")
    ...
    try:
        ...
        n_rating = None
    try:
        n_comments = tree.xpath(
            "/html/body/div[1]/div[1]/section/div/div[2]/section/section[2]/header/span/text()"
        )[0]
    except Exception:
        n_comments = None
    return [
...
if __name__ == "__main__":
    ...
    # 뽑아야하는 movie id값
    movie_ids = list(
        set(custom_movie_rating_df["MovieID"])
        - set(movie_info.loc[movie_info["Title"] != "None", "MovieID"])
    )
